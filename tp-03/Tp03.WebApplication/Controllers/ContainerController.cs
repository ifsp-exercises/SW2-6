...
namespace Tp03.WebApplication.Controllers
{
    public class ContainerController : Controller
    {
        ...
        public ContainerController(Tp03Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Numero,Tipo,Tamanho,BillOfLandingId,Id")] Container container)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Numero,Tipo,Tamanho,BillOfLandingId,Id")] Container container)
        {
            if (id != container.Id)
            {
                return NotFound();
